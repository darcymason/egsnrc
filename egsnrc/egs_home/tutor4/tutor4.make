...
# Python integrated with Fortran needs a different set of mortran files
# e.g. for some, we have modified to add (Python) callabacks to key 
# subroutines.
# => We must overwrite the SOURCES variable.
# Note: order is important!
# Note: don't forget the leading tabs on continuation lines!
#
# Standard sources from compile_user_code script
# "\$(EGS_SOURCEDIR)egsnrc.macros \$(MACHINE_MACROS) \$(RANDOM).macros 
